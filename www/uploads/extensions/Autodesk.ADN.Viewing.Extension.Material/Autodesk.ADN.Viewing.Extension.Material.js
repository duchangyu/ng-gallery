...
Autodesk.ADN.Viewing.Extension.Material = function (viewer, options) {
    ...
    _self.load = function () {
        ...
        require(dependencies, function() {
            ...
            _texMaterials.push(_self.addTexMaterial("uploads/extensions/Autodesk.ADN.Viewing.Extension.Material/wood.jpg"));
            _texMaterials.push(_self.addTexMaterial("uploads/extensions/Autodesk.ADN.Viewing.Extension.Material/steel.jpg"));
            _texMaterials.push(_self.addTexMaterial("uploads/extensions/Autodesk.ADN.Viewing.Extension.Material/brick.jpg"));
    ...
    //
    ///////////////////////////////////////////////////////////////////////////
    _self.setMaterial = function (fragId, mesh, materialName) {
    ...
    _self.addMaterial = function (color) {
        ...
        var materialName = 'ADN-Material-' + newGuid();
