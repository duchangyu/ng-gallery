...
Autodesk.ADN.Viewing.Extension.PhysicsEmbed = function (viewer, options) {
    ...
    _self.load = function () {
        ...
        var dependencies = [
            "uploads/extensions/_Autodesk.ADN.Viewing.Extension.PhysicsEmbed/ammo.js",
            "uploads/extensions/_Autodesk.ADN.Viewing.Extension.PhysicsEmbed/fpsmeter.min.js"
        ];
